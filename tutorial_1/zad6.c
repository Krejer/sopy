...
// ssize_t readv(int fildes, const struct iovec *iov, int iovcnt); - pisanie wektorowe. Funkcja do fildes wpisuje rzeczy z iov(tablica, skad pobieramy dane), iovcnt - rozmiar tablicy iov
...
int main(const int argc, const char *const *const argv)
{
    ...
    if (fd_1 == -1) // tu trzeba sprawdzać -1, bo open zwraca nieujemne w przypadku, gdy sie uda(niekoniecznie 0 jak fopen)
        ERR("open");
